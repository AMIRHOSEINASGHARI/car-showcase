...
const Footer = () => {
  return (
    <footer className="border border-gray-200 mt-10">
      <div className="flex justify-between p-6 lg:px-16 lg:my-16">
        {/* footer logo */}
        <div className="mr-10">
          <Image
            src="/logo.svg"
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mt-10 p-6 lg:px-16 lg:mt-16 border border-gray-200 text-xs md:text-base">
